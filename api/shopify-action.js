...
function getStore(storeKey) {
  ...
  if (storeKey === 'vee_web')   return { url: process.env.SHOPIFY_VEE_STORE || 'dvy00c-va.myshopify.com', clientId: process.env.SHOPIFY_VEE_CLIENT_ID, clientSecret: process.env.SHOPIFY_VEE_CLIENT_SECRET };
  return null;
}
