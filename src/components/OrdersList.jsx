...
export default function OrdersList({ userRole }) {
  ...
  const handleCopyMessage = (order) => {
    ...
    const msg = `مرحباً أ/ ${order.customer}\nللتأكيد على الأوردر الخاص بك:\nالمنتج: ${order.item}\nالإجمالي: ${total} ج.م\nوشكراً لثقتكم بنا!`;
                ...
                <tr key={order.id} className={clsx("transition-colors group", statusStyle.row)}>
                  ...
                  <td className="px-6 py-3">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); handleWhatsApp(order.phone); }} className="text-emerald-500 hover:text-emerald-600 transition-colors" title="مراسلة واتساب">
